...
const ServiceTabs: React.FC<ServiceTabsProps> = ({ activeTab, onTabChange }) => {
  return (
    <div className="flex border-b border-gray-200 mb-6">
      <button
        className={`py-2 px-4 text-sm font-medium border-b-2 ${activeTab === 'outpatient-inpatient'
      ...
      <button
        className={`py-2 px-4 text-sm font-medium border-b-2 ${activeTab === 'laboratory'
            ? 'border-blue-500 text-blue-600'
            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
          } transition-colors`}
